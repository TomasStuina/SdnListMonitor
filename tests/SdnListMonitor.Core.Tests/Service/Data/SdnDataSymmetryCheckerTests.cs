...
namespace SdnListMonitor.Core.Tests.Service.Data
{
    ...
    {
        private IComparer<ISdnEntry> m_entriesOrderComparer;

        public SdnDataSymmetryCheckerTests ()
        {
            m_entriesOrderComparer = new SdnEntryAscendingByUidComparer ();
        }
        ...
        {
            // Act & Assert
            Should.Throw<ArgumentNullException> (() => new SdnDataSymmetryChecker<ISdnEntry> (null, Mock.Of<IEqualityComparer<ISdnEntry>> ()))
                  .ParamName
        ...
        {
            // Act & Assert
            Should.Throw<ArgumentNullException> (() => new SdnDataSymmetryChecker<ISdnEntry> (m_entriesOrderComparer, null))
                  .ParamName
        ...
        public void CheckForChangesAsync_WhenOldDataSetNull_ShouldShouldThrowArgumentNullException ()
        {
            ...
            var sdnDataSymmetryChecker = new SdnDataSymmetryChecker<ISdnEntry> (m_entriesOrderComparer, entryEqualityComparer);;

            // Act & Assert
            Should.Throw<ArgumentNullException> (async () =>
                await sdnDataSymmetryChecker.CheckForChangesAsync (null, Mock.Of<ISdnDataSet<ISdnEntry>> ()))
                  .ParamName
                  .ShouldBe ("oldDataSet");
        }
        ...
        public void CheckForChangesAsync_WhenNewDataSetNull_ShouldShouldThrowArgumentNullException ()
        {
            ...
            // Act & Assert
            Should.Throw<ArgumentNullException> (async () =>
                await sdnDataSymmetryChecker.CheckForChangesAsync (Mock.Of<ISdnDataSet<ISdnEntry>> (), null))
                  .ParamName
                  .ShouldBe ("newDataSet");
        }
        ...
        public async Task CheckForChangesAsync_WhenEntriesWithSameUidAreNotEqual_ShouldReturnModifiedResult ()
        {
            ...
            var sdnDataSymmetryChecker = new SdnDataSymmetryChecker<ISdnEntry> (m_entriesOrderComparer, entryEqualityComparer.Object);
        ...
        private static ISdnDataSet<ISdnEntry> CreateSdnDataSet (params ISdnEntry[] sdnEntries) =>
            Mock.Of<ISdnDataSet<ISdnEntry>> (self => self.Entries == sdnEntries);
